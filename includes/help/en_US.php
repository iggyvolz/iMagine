...
<BODY>
    ...
    <ul>
        ...
        <li class="notpassed">June 1, 2014 - Feature Freeze/Begin Alpha</li>
        <li class="notpassed">June 15, 2014 (tentative) - End Alpha/Begin Beta</li>
        <li class="notpassed">July 1, 2014 (tentative) - End Beta/Begin RC's</li>
        <li class="notpassed">July 15, 2014 (tentative) - Final Release</li>
    </ul></p>
<h2>Setup</h2>
...
<p>Version 1.0 now requires PHP 5.4+.  Support for PHP 5.3.x will be completely discontinued by the PHP organization in July.  We will continue to provide support for the final version supported by PHP 5.3 (FTG:R 0.3) until a later date, but new features will only be added to PHP 5.4.</p>
<h2>Syntax</h2>
...
<p class="italic">This feature is in development for release in 1.1 "Boron".  We recommend that you back up your game before using this command.  You can disable its use in /includes/constants.</p>
