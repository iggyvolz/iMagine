...
require_once __DIR__ . FTGR_SLASH . 'burn.php';
...
require_once __DIR__ . FTGR_SLASH . 'electroshade.php';
...
require_once __DIR__ . FTGR_SLASH . 'kick.php';
require_once __DIR__ . FTGR_SLASH . 'lightningstrike.php';
...
require_once __DIR__ . FTGR_SLASH . 'repstrike.php';
...
require_once __DIR__ . FTGR_SLASH . 'tailwhip.php';
require_once __DIR__ . FTGR_SLASH . 'trample.php';
require_once __DIR__ . FTGR_SLASH . 'windwhap.php';
