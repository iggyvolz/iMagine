...
require realpath(__DIR__.'/__construct.php');
require realpath(__DIR__.'/__destruct.php');
...
require realpath(__DIR__.'/_register.php');
...
require realpath(__DIR__.'/update_code.php');
